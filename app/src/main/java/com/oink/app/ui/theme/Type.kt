 ...
 *
 * FONTS:
 * - Poppins: Display/numbers - friendly, rounded, great for big balance numbers
 * - Inter: Body text - clean, readable, professional
 */
...
/**
 * Poppins - used for display text, headings, and important numbers.
 * Gives that friendly, approachable vibe perfect for a gamified app.
 */
 ...
 * Clean and highly readable at all sizes.
 */
...
val OinkTypography = Typography(
    ...
    // -------------------------------------------------------------------------
    // HEADLINE - Poppins SemiBold (Section headers, important labels)
    // -------------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------------
    // TITLE - Inter SemiBold/Medium (Card titles, list item headers)
    // -------------------------------------------------------------------------
    ...
    // -------------------------------------------------------------------------
    // BODY - Inter Regular/Medium (Main content, descriptions)
    // -------------------------------------------------------------------------
    bodyLarge = TextStyle(
        fontFamily = InterFontFamily,
    ...
    // -------------------------------------------------------------------------
    // LABEL - Inter Medium/SemiBold (Buttons, chips, small labels)
    // -------------------------------------------------------------------------
